...
public class Compute {
	 ...
	 static Double[] M_RANGE_texture             =  {11.83, 15.49, 19.18, 22.84, 26.51, 30.17, 33.84, 39.4}; //new Double[5];
	 static Double[] M_RANGE_perimeter           =  {71.85, 95.20, 110.8, 126.4, 141.9, 157.44, 173.0, 188.6}; //new Double[5];
	 static Double[] M_RANGE_area                =  {365.0,789.46, 1074.72, 1359.99, 1645.27,1930.52, 2215.80,2501.10}; //new Double[5];
	 static Double[] M_RANGE_smoothness          =  {0.045, 0.07, 0.076, 0.082, 0.093, 0.105, 0.117,0.128, 0.164};//{0.40, 0.1034, 0.1264, 0.1492, 0.1606}; //new Double[5];
	 static Double[] M_RANGE_compactness         =  {0.019, 0.041, 0.085, 0.106, 0.128, 0.15, 0.172, 0.237,0.345}; //new Double[5];
	 static Double[] M_RANGE_concavity           =  {0.0239, 0.0845, 0.145, 0.2052, 0.266, 0.326, 0.387, 0.480}; //new Double[5];
	 static Double[] M_RANGE_concave             =  {0.0201, 0.0512, 0.0820, 0.113,0.144, 0.16, 0.19, 0.221, 0.252}; //new Double[5];
	 static Double[] M_RANGE_symmetry            =  {0.1172, 0.1720, 0.2085, 0.250, 0.2812, 0.32, 0.36};
	 static Double[] M_RANGE_fractaldimension    =  {0.049, 0.064, 0.0766, 0.09, 0.11}; //new Double[5];
	                                                           	
	 static Double[] B_RANGE_MeanRadius          =  {6.95, 8.40, 9.86, 11.32, 12.79, 14.25, 15.71, 17.91};//new Double[8];
	 static Double[] B_RANGE_texture             =  {9.65, 12.89, 16.12, 19.35, 22.57, 25.78, 27.41, 30.64, 33.9}; //new Double[9];
	 static Double[] B_RANGE_perimeter           =  {43.60, 57.93, 67.40,76.84, 86.30, 95.75, 105.20, 115.0}; //new Double[8];
	 static Double[] B_RANGE_area                =  {143.44, 313.20, 426.37, 539.52, 652.70, 765.84, 879.00, 992.16}; //new Double[8];
	 static Double[] B_RANGE_smoothness          =  {0.045, 0.07, 0.076, 0.082, 0.093, 0.0105, 0.117,0.128, 0.164}; //new Double[9];
	 static Double[] B_RANGE_compactness         =  {0.019, 0.041, 0.085, 0.106, 0.128, 0.15, 0.172, 0.237,0.345};//new Double[9];
	 static Double[] B_RANGE_concavity           =  {0.0000, 0.0615, 0.1230, 0.2150, 0.338, 0.47}; //new Double[6];
	 static Double[] B_RANGE_concave             =  {0.0000, 0.0181, 0.0362, 0.0542, 0.0723, 0.099}; //new Double[6];
	 static Double[] B_RANGE_symmetry            =  {0.0918, 0.1455, 0.1813, 0.2171, 0.2529, 0.2886, 0.32}; // new Double[7];
	 static Double[] B_RANGE_fractaldimension    =  {0.0490,0.06, 0.07, 0.08, 0.09, 0.10}; //new Double[6];
	
	 //COUNT HOLDERS FOR OCCURENCES IN EACH RANGE
	 static Double[] M_MeanRadius          =  new Double[8];
