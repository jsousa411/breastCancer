...
public class Compute { 
	 ...
	 static Double[] M_RANGE_MeanRadius          =  {10.040, 14.34, 16.64, 18.94, 21.24, 23.54, 25.84, 28.17}; //M mean radius ranges;
	 ...
	 static Double[] B_RANGE_MeanRadius          =  {6.95, 8.40, 9.86, 11.32, 12.79, 14.25, 15.71, 17.91}; 
	 ...
	 static Double[] B_RANGE_smoothness          =  {0.045, 0.07, 0.076, 0.082, 0.093, 0.0105, 0.117,0.128, 0.164}; 
	 static Double[] B_RANGE_compactness         =  {0.019, 0.041, 0.085, 0.106, 0.128, 0.15, 0.172, 0.237,0.345};
	 ...
	 static Double[] B_RANGE_symmetry            =  {0.0918, 0.1455, 0.1813, 0.2171, 0.2529, 0.2886, 0.32};
